...
class Ui_Currency(object):
    def setupUi(self, Currency):
        ...
        self.btn__data_refresh = QtWidgets.QPushButton(self.frm_front)
        self.btn__data_refresh.setGeometry(QtCore.QRect(490, 62, 150, 70))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        self.btn__data_refresh.setFont(font)
        self.btn__data_refresh.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn__data_refresh.setStyleSheet("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Icons/icons/exchange.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn__data_refresh.setIcon(icon6)
        self.btn__data_refresh.setIconSize(QtCore.QSize(30, 60))
        self.btn__data_refresh.setObjectName("btn__data_refresh")
    ...
    def retranslateUi(self, Currency):
        ...
        self.btn__data_refresh.setText(_translate("Currency", "Reload"))
        ...
        self.lbl_rate_chf.setText(_translate("Currency", "1.00"))
        self.lbl_rate_cad.setText(_translate("Currency", "1.00"))
        self.lbl_rate_rub.setText(_translate("Currency", "1.00"))
        self.lbl_rate_jpy.setText(_translate("Currency", "1.00"))
        self.lbl_buy_cad.setText(_translate("Currency", "1.00"))
        self.lbl_buy_rub.setText(_translate("Currency", "1.00"))
        self.lbl_buy_usd.setText(_translate("Currency", "1.00"))
        self.lbl_buy_chf.setText(_translate("Currency", "1.00"))
